...
// Attach polygon to analysis request
const origAnalyze = document.getElementById('btnAnalyze').onclick;
document.getElementById('btnAnalyze').onclick = async () => {
  if (!roiPolygon && !roiMode) { await origAnalyze?.call ? origAnalyze() : doAnalyze(); return; }
